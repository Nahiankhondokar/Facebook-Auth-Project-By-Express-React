...
import { CreateUser, DeleteUser, GetAllUser, SingleUser, UpdateUser, UserLogin, UserRegister, UserAccontVerify, TriedToPassResetUser, UserResetPassword, LoggedInUserData } from '../controllers/userController.js';
...
router.route('/me').get(LoggedInUserData);
